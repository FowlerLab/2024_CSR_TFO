...
python msa_pacbio.py -d . -o output/FIX_allbc_noCterm_barcode_variant_map.txt \
	--highQual input/FIX_allbc_noCterm_combined_minQ0_assignment.tsv \
	--inputSeqs input/FIX_allbc_noCterm_seq_barcodes.txt \
	-c 2 -t 0.6 -v -s \
